...
def load_data():
    try:
        ...
        # Tạo cột gợi ý kết hợp ID và Tên
...
if res:
    ...
    with col_lang:
        ...
        L = TEXTS[lang]
    with col_search:
        # SỬ DỤNG SELECTBOX LÀM Ô TÌM KIẾM TRỰC TIẾP (AUTOCOMPLETE)
        # Placeholder được đặt làm giá trị đầu tiên
        search_options = [""] + df['Search_Key'].tolist()
        choice = st.selectbox(
            "Search", 
